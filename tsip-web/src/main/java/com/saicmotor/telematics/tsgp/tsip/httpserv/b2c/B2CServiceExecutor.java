...
package com.saicmotor.telematics.tsgp.tsip.httpserv.b2c;
...
public class B2CServiceExecutor extends BaseServiceExecutor {

	private static final Logger LOGGER = LoggerFactory.getLogger(B2CServiceExecutor.class);
