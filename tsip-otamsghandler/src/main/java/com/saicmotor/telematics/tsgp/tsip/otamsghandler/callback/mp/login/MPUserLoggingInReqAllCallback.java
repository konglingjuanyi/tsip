 ...
 */
public class MPUserLoggingInReqAllCallback extends OTACallback {
        ...
        if ("1.0".equals(appVersion)) {
            new OTATransform.Converter() {
                ...
                public void convert(Object requestObj, Object serverObj) {
                    ...
                    Object clientResp = fastCopy(serviceResp, com.saicmotor.telematics.tsgp.otaadapter.mp.v1_1.entity.login.MP_UserLoggingInResp.class);
