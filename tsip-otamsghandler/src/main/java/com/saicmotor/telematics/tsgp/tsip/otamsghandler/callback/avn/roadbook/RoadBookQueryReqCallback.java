 ...
 */
public class RoadBookQueryReqCallback extends OTACallback {
        ...
        if ("1.1".equals(clientVersion) && "1.1".equals(serviceVersion)) {
            new OTATransform.Converter() {
                ...
                public void convert(Object requestObj, Object serverObj) {
                    ...
                    Object serviceResp =  decode(com.saicmotor.telematics.tsgp.otaadapter.roadbook.v1_1.entity.roadbook.RoadBookQueryResp.class, serviceBytes);
                    Object clientResp = fastCopy(serviceResp, com.saicmotor.telematics.tsgp.otaadapter.avn.v1_1.entity.roadbook.RoadBookQueryResp.class);
